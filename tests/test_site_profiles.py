...
class SiteProfileContractTestCase(unittest.TestCase):
    ...
    def test_viper_cpu_profile_enforces_site_and_login_node_contracts(self) -> None:
        ...
        self.assertIn("queueSize = 0", text)
        self.assertIn("pollInterval = '1 min'", text)
        self.assertIn("queueStatInterval = '5 min'", text)
        ...
        self.assertIn("stageOutMode = 'copy'", text)
        self.assertLess(text.index("viper05i"), text.index("process {"))
